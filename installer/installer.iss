...
#define Launcher "..\ALVR\bin\Release\AirQuest.exe"
...
AppSupportURL=
AppUpdatesURL=
DefaultDirName={pf}\AirQuest
DefaultGroupName=AirQuest
LicenseFile=..\LICENSE
OutputDir=..\release-files
OutputBaseFilename=AirQuest-setup-{#ApplicationVersion}
Compression=lzma
SolidCompression=yes
PrivilegesRequired=admin
ArchitecturesInstallIn64BitMode=x64
ArchitecturesAllowed=x64
UninstallDisplayIcon={app}\AirQuest.exe
...
[Files]
Source: "..\ALVR\bin\Release\AirQuest.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\AirQuest"; Filename: "{app}\AirQuest.exe"

[UninstallDelete]
;This works only if it is installed in default location
Type: filesandordirs; Name: "{pf}\AirQuest"

;This works if it is installed in custom location
Type: files; Name: "{app}\*"; 
Type: filesandordirs; Name: "{app}"

Type: files; Name: "{pf32}\FreePIE\plugins\AirQuestFreePIE.dll"; 
